...
export class PersonalizedController {
  constructor(
    @Inject(PersonalizedService)
    private readonly personalizedService: PersonalizedService,
  ) {}
  @ApiOperation({
    summary: '推荐歌单',
    description:
      '说明 : 调用此接口 , 可获取推荐歌单 实例： /personalized?limit=1',
  })
  @Get()
  ...
  @ApiOperation({
    summary: '推荐 mv',
    description: ' 说明 : 调用此接口 , 可获取推荐 mv, 实例： /personalized/mv',
  })
  @Get('/mv')
  ...
  @ApiOperation({
    summary: '推荐新音乐',
    description:
      '说明 : 调用此接口 , 可获取推荐新音乐 实例： /personalized/newsong',
  })
  @Get('/newsong')
  ...
  @ApiOperation({
    summary: '推荐电台',
    description:
      '说明 : 调用此接口 , 可获取推荐电台 实例： /personalized/djprogram',
  })
  @Get('/djprogram')
  ...
  @ApiOperation({
    summary: '独家放送',
    description:
      ' 说明 : 调用此接口 , 可获取独家放送 实例：/personalized/privatecontent',
  })
  @Get('/privatecontent')
